...
`products/plan/docs/architecture/repository_layout.md` from the workspace root.
...
- `platform/agent-runtimes/gitagent`: generic Agent runtime; it imports no product code.
- `products/dwg`: independent DWG product and process;
...
`generic GitAgent runtime API -> discover products/plan/agents/planm workflow and stage skill`
