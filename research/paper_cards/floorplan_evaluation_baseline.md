...
efficiency, and compactness are soft quality metrics. A run preserves the best
candidate, structured violations, deterministic SHA-256 fingerprint, lineage,
ranking inputs, and an explicit termination reason.
...
ranking and lineage make every refinement auditable.
